const Vpaid = class {
  ...
  trackings =
      '<script type="text/plain"><IMG SRC="https://ad.doubleclick.net/ddm/trackimp/N445802.3298035BLIINK/B27207842.327719184;dc_trk_aid=522977935;dc_trk_cid=168111063;ord=[timestamp];dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=;gdpr=${GDPR};gdpr_consent=${GDPR_CONSENT_755};ltd=?" BORDER="0" HEIGHT="1" WIDTH="1" ALT="Advertisement"><SCRIPT TYPE="application/javascript" SRC="https://pixel.adsafeprotected.com/rjss/st/949130/61464322/skeleton.js?ias_dspID=64"></SCRIPT> <NOSCRIPT><IMG SRC="https://pixel.adsafeprotected.com/rfw/st/949130/61464321/skeleton.gif?gdpr=${GDPR}&gdpr_consent=${GDPR_CONSENT_278}&gdpr_pd=${GDPR_PD}&ias_dspID=64" BORDER=0 WIDTH=1 HEIGHT=1 ALT=""></NOSCRIPT><img width="1" height="1" style="border:0" src="https://tr.impptk.com/impr?tid=3a275612-ea37-4dce-8c08-1c3d658af87d&tracker=bliink_fullimage_pompe&ttype=impression&ssp=[ssp]&dev_type=[device]&conn_type=[connexion]&ts=${CB}" /></script>'
  videoStylesFormat =
