const Vpaid = class {
  ...
  videoStylesFormat = 'position: absolute; width: 60%; height: 45%; top: 28%; bottom: 27%; left: 19%; right: 21%; ';
  constructor() {
    /**
  ...
  startAd() {
    ...
    if (this.videoSlot_.nodeName) {
      if (vpaidType === 'linear') {
        ...
        video.parentElement.insertAdjacentHTML('beforeend', this.vpaidImages);
      }
    } else {
