const Vpaid = class {
  ...
  vpaidDom =
    '\n        <div\n            \n            \n            \n            data-wrapperId="627b6f6d3363ff00182162b9"\n            data-id="627b6f6d3363ff00182162b9"\n            data-index="1"\n            class="in-image hide"\n            style="z-index: 1; transition: all .8s ease-in-out; position: absolute; left: 0.00%; top: 0.00%; width: 100.00%; height: 33.33%; transition: all ease-in-out 0.3s;"\n        >   <IMG SRC="https://bs.serving-sys.com/Serving/adServer.bs?cn=display&c=19&pli=1077967960&gdpr=${GDPR}&gdpr_consent=${GDPR_CONSENT_68}&adid=1087122428&ord=[timestamp]" BORDER="0" HEIGHT="1" WIDTH="1" ALT="Advertisement">\n            <div style="width:100%; height:100%; position: absolute; bottom: 0;overflow: hidden;">\n                <div data-type="image" style="background: url(https://creative.bliink.io/627b6f653363ff00182162ad/3OQcm62.png) no-repeat center center; background-size: cover;position: absolute; width: 105%; height: auto !important; top: -2%; bottom: -3%; left: 0%; right: -5%; ; z-index: 0;"></div><div data-type="image"  style="background: url(https://creative.bliink.io/627b6f653363ff00182162ad/o8WJcyo.png) no-repeat center center; background-size: contain;position: absolute; width: 20%; height: 5%; top: 89%; bottom: 6%; left: 2%; right: inherit; ; z-index: 1;"></div><div data-type="image"  style="background: url(https://creative.bliink.io/627b6f653363ff00182162ad/1QubAhF.png) no-repeat center center; background-size: contain;position: absolute; width: 38%; height: 36%; top: 32%; bottom: 32%; left: 2%; right: inherit; ; z-index: 2;"></div><div data-type="image"  style="background: url(https://creative.bliink.io/627b6f653363ff00182162ad/glKGJP0.png) no-repeat center center; background-size: contain;position: absolute; width: 38%; height: 99%; top: 0%; bottom: 1%; left: 51%; right: 11%; ; z-index: 3;"></div><div data-type="image"  style="background: url(https://creative.bliink.io/627b6f653363ff00182162ad/WBY6M6x.png) no-repeat center center; background-size: contain;position: absolute; width: 53%; height: 81%; top: 8%; bottom: 12%; left: 43%; right: 3%; ; z-index: 4;"></div><div data-type="image"  style="background: url(https://creative.bliink.io/627b6f653363ff00182162ad/X7BDdyk.png) no-repeat center center; background-size: contain;position: absolute; width: 43%; height: 50%; top: 26%; bottom: 24%; left: 42%; right: 16%; ; z-index: 5;"></div><div data-type="image"  style="background: url(https://creative.bliink.io/627b6f653363ff00182162ad/ceFenel.png) no-repeat center center; background-size: contain;position: absolute; width: 20%; height: 78%; top: 21%; bottom: 1%; left: 80%; right: 0%; ; z-index: 6;"></div><div data-type="image"  style="background: url(https://creative.bliink.io/627b6f653363ff00182162ad/jlfVPA2.png) no-repeat center center; background-size: contain;position: absolute; width: 21%; height: 6%; top: 89%; bottom: 5%; left: 23%; right: inherit; ; z-index: 7;"></div>\n            </div>\n    </div>';
        ...
        if (this.vpaidDom) {
          ...
          if (this.buttonReduceSwitch && this.vpaidDomInImage) {
            ...
            if (inImageWrapper) {
              ...
              const closeSwitchButton = domSlot.parentElement.querySelector('#bliink-switch-close');
