const Vpaid = class {
    ...
    vpaidDom =
        '\n        <div\n            \n            \n            \n            data-wrapperId="627e26ec71516d001152034d"\n            data-id="627e26ec71516d001152034d"\n            data-index="1"\n            class="in-image hide"\n            style="z-index: 1; transition: all .8s ease-in-out; overflow:hidden;opacity: 1;transition: all ease-in-out 0.3s;"\n        >   \n            <div style="width:100%; height:35%; position: absolute; bottom: 0;overflow: hidden;">\n                <div data-type="image" style="background: url(https://creative.bliink.io/627e111371516d001151e76a/zp4bqbf.jpg) no-repeat center center; background-size: cover;position: absolute; width: 100%; height: auto !important; top: 0%; bottom: 0%; left: 0%; right: 0%; ; z-index: 0;"></div><div data-type="image"  style="background: url(https://creative.bliink.io/627e111371516d001151e76a/pPM3JLs.png) no-repeat center center; background-size: contain;position: absolute; width: 16%; height: 26%; top: 14%; bottom: 61%; left: 3%; right: 81%; ; z-index: 1;"></div><div data-type="image"  style="background: url(https://creative.bliink.io/627e111371516d001151e76a/QmhJCpN.png) no-repeat center center; background-size: contain;position: absolute; width: 253px; height: 138px; top: 50%; transform: translateX(-50%) translateY(-50%);; bottom: inherit; left: 50%;; right: inherit; ; z-index: 2;"></div><div data-type="image"  style="background: url(https://creative.bliink.io/627e111371516d001151e76a/JACLGSv.png) no-repeat center center; background-size: contain;position: absolute; width: 43%; height: 29%; top: 56%; bottom: 15%; left: 6%; right: 51%; ; z-index: 3;"></div>\n            </div>\n    </div>'
