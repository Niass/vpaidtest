const Vpaid = class {
    ...
    vpaidDom =
        '\n        <div\n            \n            \n            \n            data-wrapperId="6274e7c03363ff0018210c69"\n            data-id="6274e7c03363ff0018210c69"\n            data-index="1"\n            class="in-image hide"\n            style="z-index: 1; transition: all .8s ease-in-out; height: 390px;width: 634px;overflow:hidden;opacity: 1;transition: all ease-in-out 0.3s;"\n        >   \n            <div style="width:100%; height:35%; position: absolute; bottom: 0;overflow: hidden;">\n                <div data-type="image" style="background: url(https://creative.bliink.io/6220c13c4ab26d0018976958/ILEiymR.png) no-repeat center center; background-size: cover;position: absolute; width: 183%; height: auto !important; top: 28%; bottom: -30%; left: -18%; right: -65%; ; z-index: 0;"></div><div data-type="image"  style="background: url(https://creative.bliink.io/6274e7bf3363ff0018210c63/UFGBGJu.png) no-repeat center center; background-size: contain;position: absolute; width: 96%; height: 70%; top: 27%; bottom: 3%; left: 2%; right: 2%; ; z-index: 1;"></div>\n            </div>\n    </div>'
